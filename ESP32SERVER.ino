...
String FIRMWARE_VERSION = "__VERSION__"; // ¡Cambia esto en tu código cada vez que subas una actualización!
...
const unsigned long INTERVALO_OTA = 300000; // 3.600.000 ms = 1 hora
